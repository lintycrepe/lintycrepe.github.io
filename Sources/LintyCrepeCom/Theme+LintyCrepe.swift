...
public extension Theme {
    ...
    static var lintycrepe: Self {
            Theme(
                htmlFactory: LintyCrepeHTMLFactory(),
                resourcePaths: ["Resources/LintyCrepeTheme/styles.css"]
            )
        }
}

private struct LintyCrepeHTMLFactory<Site: Website>: HTMLFactory {
    ...
    var body: Component {
        Footer {
            Paragraph {
                ...
                Link("Git Repository", url: "https://github.com/lintycrepe/lintycrepe.github.io")
            }
        }
    }
}